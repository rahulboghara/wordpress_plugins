...
$resposive_breakpoint_width = (isset($wpmm_custom_theme['mobile_settings']['resposive_breakpoint_width']))?$wpmm_custom_theme['mobile_settings']['resposive_breakpoint_width']:'991px';
...
<?php if($transform != ''){ ?>text-transform: <?php echo $transform;?> !important;<?php } ?>
