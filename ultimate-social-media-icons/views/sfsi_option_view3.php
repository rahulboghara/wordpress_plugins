                ...
                <li class="cstomskins_upload">
                    ...
                    <div class="icns_tab_3" style="padding-left: 6px;">
                        ...
                        if (get_option("whatsapp_skin")) {
                            ...
                            echo '<span class="row_17_10 whatsapp_section sfsi-bgimage" style="background: url(' . $icon . ') no-repeat;"></span>';
                        } else {

                            echo '<span class="row_17_10 whatsapp_section" style="background-position:-977px 0;"></span>';
                        }
