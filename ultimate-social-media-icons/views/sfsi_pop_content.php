    ...
    <div class="cstmskin_popup" >
        ...
        <div class="cstomskins_wrpr">
            ...
            <ul class="cstmskin_iconlist">
				...
				<li>
                	<div class="cstm_icnname">whatsapp</div>
                    <div class="cstmskins_btn">
                    	<?php 
							if(get_option("whatsapp_skin"))
							{
								$whatsapp_skin = get_option("whatsapp_skin");
								echo "<img src='".$whatsapp_skin."' width='30px' height='30px' class='imgskin' alt='whatsapp'>";
								echo '<a href="javascript:" onclick="upload_image(this);" title="whatsapp_skin" class="cstmskin_btn">Update</a>';
								echo '<a href="javascript:" onclick="deleteskin_icon(this);" title="whatsapp_skin" data-nonce="'.$nonce.'" class="cstmskin_btn">Delete</a>';
							}
							else
							{
								echo "<img src='' width='30px' height='30px' class='imgskin skswrpr' alt='whatsapp'>";
								echo '<a href="javascript:" onclick="upload_image(this);" title="whatsapp_skin" class="cstmskin_btn">Upload</a>';
								echo '<a href="javascript:" onclick="deleteskin_icon(this);" title="whatsapp_skin" data-nonce="'.$nonce.'" class="cstmskin_btn dlt_btn">Delete</a>';		
							}
						?>
                    </div>
				</li>
