...
$option2['sfsi_vk_pageURL']                 = (isset($option2['sfsi_vk_pageURL']))
    ...
    : '';
$option2['sfsi_whatsapp_page']                 = (isset($option2['sfsi_whatsapp_page']))
    ? sanitize_text_field($option2['sfsi_whatsapp_page'])
    : '';
$option2['sfsi_whatsapp_pageURL']                 = (isset($option2['sfsi_whatsapp_pageURL']))
    ? esc_url($option2['sfsi_whatsapp_pageURL'])
    : '';
...
<div class="tab2">
    ...
    <div class="row whatsapp_section">
        ...
        <div class="inr_cont whatsapp_tab_2">
            <p>When clicked on, users will get directed to your whatsapp page.</p>

            <p class="radio_section fb_url no_check"><input name="sfsi_whatsapp_page" checked="true" type="checkbox" value="yes" class="" style="display:none" /><label>Visit me on whatsapp:</label><input name="sfsi_whatsapp_pageURL" type="url" placeholder="http://" value="<?php echo ($option2['sfsi_whatsapp_pageURL'] != '') ?  $option2['sfsi_whatsapp_pageURL'] : ''; ?>" class="add" /></p>

            <div class="sfsi_new_prmium_follw">
                <p><b>New: </b> In our Premium Plugin you can now give whatsapp icon other functions too, e.g. <b>your website/blog, share your website/blog</b> on whatsapp. <a style="cursor:pointer" class="pop-up" data-id="sfsi_quickpay-overlay" onclick="sfsi_open_quick_checkout(event)" class="sfisi_font_bold" target="_blank">Go premium now</a><a href="https://www.ultimatelysocial.com/usm-premium/?utm_source=usmi_settings_page&utm_campaign=whatsapp_like_and_share&utm_medium=banner" class="sfsi_font_inherit" target="_blank"> or learn more.</a></p>
            </div>
        </div>
    </div>
    <!-- END whatsapp ICON -->
