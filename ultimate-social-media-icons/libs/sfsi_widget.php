...
<?php
   ...
   $icons = unserialize($sfsi_section1_options['sfsi_custom_files']);
        ...
        if(!isset($sfsi_section5['sfsi_whatsappIcon_order'])){                     
            $sfsi_section5['sfsi_whatsappIcon_order']    = '14';
        }
   ...
   else
   {
	...
	break;	  
	case 'whatsapp' :  if($sfsi_section1_options['sfsi_whatsapp_display']=='yes')    $icons.= sfsi_prepairIcons('whatsapp'); 
	break;	  
 ...
 //    $scheme = (!empty($_SERVER['HTTPS']) && $_SERVER['HTTPS'] !== 'off' || $_SERVER['SERVER_PORT'] == 443) ? "https" : "http";
	...
	switch($icon_name)
    {
	   ...
	   case "pinterest" :
        ...
        break;
        case "whatsapp" :		 
				$toolClass = "whatsapp_tool_bdr";
				$arrow_class = "bot_pintst_arow";
				
				$url = (isset($sfsi_section2_options['sfsi_whatsapp_pageURL'])) ? $sfsi_section2_options['sfsi_whatsapp_pageURL'] : '';
				
				// $whatsapp_user_name = isset($sfsi_section4_options['sfsi_whatsapp_User']) && !empty($sfsi_section4_options['sfsi_whatsapp_User']) ? $sfsi_section4_options['sfsi_whatsapp_User'] : false;
				...
				$cDisplay = isset($sfsi_section4_options['sfsi_whatsapp_countsDisplay']) && !empty($sfsi_section4_options['sfsi_whatsapp_countsDisplay']) ? $sfsi_section4_options['sfsi_whatsapp_countsDisplay']: false;
				...
				if($active_theme == 'custom_support')
				{
					 ...
					 else
					 {
						...
						$icons_baseUrl = SFSI_PLUGURL."images/icons_theme/default/";
						$icon=$icons_baseUrl."default_whatsapp.png";
					 }
				}
				else
				{
