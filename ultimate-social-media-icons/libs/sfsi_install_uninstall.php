...
function sfsi_update_plugin()
{
    ...
    if (isset($option5) && !empty($option5)) {
        ...
        if (!isset($option5['sfsi_whatsappIcon_order'])) {
            $option5['sfsi_whatsappIcon_order']    = '14';
        }
...
function sfsi_activate_plugin()
{
    ...
    if (!isset($option1) || empty($option1)) {
        ...
        $options1 = array(
            'sfsi_rss_display' => 'no',
            'sfsi_email_display' => 'no',
            'sfsi_facebook_display' => 'yes',
            'sfsi_twitter_display' => 'no',
    ...
    if (!isset($option2) || empty($option2)) {
        ...
        $options2 = array(
            ...
            'sfsi_whatsapp_page'       => 'no',
            'sfsi_whatsapp_pageURL'       => '',
            'sfsi_vk_page'       => 'no',
            'sfsi_vk_pageURL'       => '',
            'sfsi_ok_page'       => 'no',
            'sfsi_ok_pageURL'       => '',
