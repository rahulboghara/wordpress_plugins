...
function sfsi_Iamdone()
{
    ...
    if(!current_user_can('manage_options')){ echo json_encode(array('res'=>'not allowed'));die(); }
	 ...
	 if(get_option("whatsapp_skin"))
	 {
		...
		$return .= '<span class="row_17_10 whatsapp_section sfsi-bgimage" style="background: url('.$icon.') no-repeat;"></span>';
	 }else
	 {
		$return .= '<span class="row_17_10 whatsapp_section" style="background-position:-977px 0;"></span>';
	 }
