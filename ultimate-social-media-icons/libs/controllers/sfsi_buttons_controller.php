...
function sfsi_options_updater1()
{
    ...
    $sfsi_facebook_display      = isset($_POST["sfsi_facebook_display"]) ? sanitize_text_field($_POST["sfsi_facebook_display"]) : 'yes';
    ...
    $sfsi_whatsapp_display         = isset($_POST["sfsi_whatsapp_display"]) ? sanitize_text_field($_POST["sfsi_whatsapp_display"]) : 'yes';

    $sfsi_instagram_display     = isset($_POST["sfsi_instagram_display"]) ? sanitize_text_field($_POST["sfsi_instagram_display"]) : 'yes';
    $sfsi_linkedin_display      = isset($_POST["sfsi_linkedin_display"]) ? sanitize_text_field($_POST["sfsi_linkedin_display"]) : 'yes';
...
function sfsi_options_updater2()
{
    ...
    $sfsi_whatsapp_page            = isset($_POST["sfsi_whatsapp_page"]) ? sanitize_text_field($_POST["sfsi_whatsapp_page"]) : 'no';
    $sfsi_whatsapp_pageURL            = isset($_POST["sfsi_whatsapp_pageURL"]) ? esc_url(trim($_POST["sfsi_whatsapp_pageURL"])) : '';
    ...
    $up_option2 = array(
        ...
        /* whatsapp options */
        'sfsi_whatsapp_page'       => sanitize_text_field($sfsi_whatsapp_page),
        'sfsi_whatsapp_pageURL'       => esc_url($sfsi_whatsapp_pageURL),
        /* vk options */
...
function sfsi_options_updater5()
{
    ...
    $sfsi_whatsappIcon_order           = isset($_POST["sfsi_whatsappIcon_order"]) ? sanitize_text_field($_POST["sfsi_whatsappIcon_order"]) : '14';
...
function sfsi_options_updater9()
{
    ...
    $sfsi_show_via_shortcode        = isset($_POST["sfsi_show_via_shortcode"])       ? sanitize_text_field($_POST["sfsi_show_via_shortcode"])  : 'yes';
