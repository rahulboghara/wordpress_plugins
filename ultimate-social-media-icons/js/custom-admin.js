...
function sfsi_update_step1() {
    ...
    var s = !1,
        ...
        wb = SFSI("input[name='sfsi_whatsapp_display']:checked").val(),
...
function sfsi_update_step2() {
    ...
    var i = 1 == SFSI("input[name='sfsi_rss_url']").prop("disabled") ? "" : SFSI("input[name='sfsi_rss_url']").val(),
        ...
        wp = 1 == SFSI("input[name='sfsi_whatsapp_page']").prop("disabled") ? "" : SFSI("input[name='sfsi_whatsapp_page']:checked").val(),
        wpu = SFSI("input[name='sfsi_whatsapp_pageURL']").val(),
    ...
    var M = {
        ...
        sfsi_whatsapp_page: wp,
        sfsi_whatsapp_pageURL: wpu,
        sfsi_vk_page: vp,
        sfsi_vk_pageURL: vpu,
        sfsi_ok_page: op,
        sfsi_ok_pageURL: opu,
...
function sfsi_update_step4() {
    ...
    var e = SFSI("input[name='sfsi_display_counts']:checked").val(),
        ...
        wc = 1 == SFSI("input[name='sfsi_whatsapp_countsDisplay']").prop("disabled") ? "" : SFSI("input[name='sfsi_whatsapp_countsDisplay']:checked").val(),
        wm = SFSI("input[name='sfsi_whatsapp_manualCounts']").val(),
        ...
        $ = {
            ...
            sfsi_whatsapp_countsDisplay: wc,
            sfsi_whatsapp_manualCounts: wm,
...
function sfsi_update_step5() {
    ...
    var i = SFSI("input[name='sfsi_icons_size']").val(),
        ...
        wbi = SFSI("#sfsi_whatsappIcon_order").attr("data-index"),
    ...
    var v = 1 == SFSI("input[name='sfsi_rss_MouseOverText']").prop("disabled") ? "" : SFSI("input[name='sfsi_rss_MouseOverText']").val(),
        ...
        wb = 1 == SFSI("input[name='sfsi_whatsapp_MouseOverText']").prop("disabled") ? "" : SFSI("input[name='sfsi_whatsapp_MouseOverText']").val(),
    ...
    var T = {
        ...
        sfsi_whatsapp_MouseOverText: wb,
...
function sfsi_validationStep2() {
    ...
    /* whatsapp validation */
    if (sfsi_validator(SFSI('input[name="sfsi_whatsapp_display"]'), 'checked')) {
        if (!sfsi_validator(SFSI('input[name="sfsi_whatsapp_pageURL"]'), 'blank')) {
            showErrorSuc("error", "Error : Invalid whatsapp url ", 2);
            SFSI('input[name="sfsi_whatsapp_pageURL"]').addClass('inputError');
            return false;
        }
    }
    /* LinkedIn validation */
...
function sfsi_validationStep5() {
    ...
    if (parseInt(SFSI('input[name="sfsi_icons_size"]').val()) > 130) {
        showErrorSuc("error", "Error : Icons Size allow  130px maximum ", 5);
        SFSI('input[name="sfsi_icons_size"]').addClass('inputError');
        return false;
    }
