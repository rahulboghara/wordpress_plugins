...
function wc_replace_policy_page_link_placeholders( $text ) {
	...
	$terms_link      = $terms_page_id ? '<span  class="woocommerce-terms-and-conditions-link" >' . __( 'terms and conditions', 'woocommerce' ) . '</span>' : __( 'terms and conditions', 'woocommerce' );
...
if ( ! function_exists( 'woocommerce_template_loop_category_title' ) ) {
	...
	function woocommerce_template_loop_category_title( $category ) {
		...
		<div class="woocommerce-loop-category__title">
			...
			<?php
				echo apply_filters( 'woocommerce_subcategory_count_html', ' <span class="count">' . esc_html( $category->count . ' products') . '</span>', $category ); // WPCS: XSS ok.
			?>
		</div>
		<?php
	}
