...
! defined( 'WOOSW_VERSION' ) && define( 'WOOSW_VERSION', '1.4.9' );
		...
		if ( ! class_exists( 'WPcleverWoosw' ) ) {
			class WPcleverWoosw {
				...
				function shortcode( $atts ) {
					...
					if ( $atts['id'] ) {
						...
						if ( array_key_exists( $atts['id'], self::$woosw_added ) ) {
							...
							$woosw_text  = get_option( 'woosw_button_text_added' );
							if ( empty( $woosw_text ) ) {
								$woosw_text = esc_html__( 'Browse wishlist', 'woosw' );
							}
							$woosw_text = apply_filters( 'woosw_button_text_added', $woosw_text );
						} else {
							$woosw_text = get_option( 'woosw_button_text' );
							if ( empty( $woosw_text ) ) {
								$woosw_text = esc_html__( 'Add to wishlist', 'woosw' );
							}
                                    ...
                                    <table class="form-table">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <span class="description">
													<?php esc_html_e( 'Leave blank if you want to use the default text and can be translated.', 'woosw' ); ?>
												</span>
                                            </td>
                                        </tr>
                                        <tr>
											...
											<?php esc_html_e( 'The action when clicking on the wishlist button.', 'woosw' ); ?>
										</span>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
											...
											<?php esc_html_e( 'The action when clicking on the wishlist button (added).', 'woosw' ); ?>
										</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="url" name="woosw_continue_url"
                                                       ...
                                                       class="regular-text code"/> <span
                                                        class="description">
											<?php esc_html_e( 'By default, only hide the popup when clicking on "Continue shopping" button.', 'woosw' ); ?>
										</span>
                                            </td>
                                        </tr>
                                        <tr class="heading">
											...
											This feature only available on the Premium Version. Click <a
                                        ...
                                        <tr class="submit">
                                            <th colspan="2">
                                                ...
                                                <input type="hidden" name="page_options"
                                                       value="woosw_disable_unauthenticated,woosw_auto_remove,woosw_page_id,woosw_page_share,woosw_page_copy,woosw_button_type,woosw_button_text,woosw_button_action,woosw_button_text_added,woosw_button_action_added,woosw_button_class,woosw_button_position_archive,woosw_button_position_single,woosw_cats,woosw_color,woosw_continue_url,woosw_menus,woosw_menu_action"/>
                                            </th>
                                        </tr>
                                    </table>
                                </form>
				...
				function wp_enqueue_scripts() {
					...
					// text added
					$woosw_text_added = get_option( 'woosw_button_text_added' );
					if ( empty( $woosw_text_added ) ) {
						$woosw_text_added = esc_html__( 'Browse wishlist', 'woosw' );
					}
					$woosw_text_added = apply_filters( 'woosw_button_text_added', $woosw_text_added );
					...
					wp_localize_script( 'woosw-frontend', 'woosw_vars', array(
							...
							'button_text_added'   => esc_html( $woosw_text_added ),
